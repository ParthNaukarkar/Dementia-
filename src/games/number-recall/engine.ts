...
export const NUMBER_RECALL_TIERS: NumberRecallDifficulty[] = [
  ...
  },
  {
    ...
    discriminationA: 1.7,
    tierDescription: {
      as: 'স্তৰ ৭: ৫টা সংখ্যা (১.২ ছেকেণ্ড দৃষ্টিগত প্ৰদৰ্শন, ওলোটা ক্ৰম)',
      bn: 'স্তর ৭: ৫টি সংখ্যা (১.২ সেকেন্ড দৃষ্টিগত প্রদর্শন, বিপরীত ক্রম)',
      hi: 'स्तर ७: ५ अंक (१.२ सेकंड दृश्य प्रदर्शन, विपरीत क्रम)',
      en: 'Tier 7: 5 Digits (1.2s Visual Exposure, Reverse Order Recall)',
    },
  },
  {
    tierLevel: 8,
  ...
  },
  {
    ...
    discriminationA: 1.8,
    tierDescription: {
      as: 'স্তৰ ৯ (সৰ্বোচ্চ সীমা): ৮টা সংখ্যা (০.৬ ছেকেণ্ড দৃষ্টিগত ফ্লেশ, ওলোটা ক্ৰম)',
      bn: 'স্তর ৯ (সর্বোচ্চ সীমা): ৮টি সংখ্যা (০.৬ সেকেন্ড দৃষ্টিগত ফ্ল্যাশ, বিপরীত ক্রম)',
      hi: 'स्तर ९ (शीर्ष चुनौती): ८ अंक (०.६ सेकंड दृश्य फ्लैश, विपरीत क्रम)',
      en: 'Tier 9 (Cognitive Ceiling): 8 Digits (600ms Visual Flash Only, Reverse Order)',
    },
  },
];
